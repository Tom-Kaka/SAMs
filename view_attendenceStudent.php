...
<body>
  ...
  <!--sidebar start-->
   <div class="sidebar">
        ...
        <a href="view_attendenceStudent.php">     <span>Attendance</span></a>  
  ...
  <!--sidebar end-->
   ...
   <div class="btn_group">
       ...
       <form method="POST" action="fetch_StudentAttendance.php" class="lolo">
       ...
       <h4>Choose Subject:</h4>           
          ...
          <option value="form4">Form 4</option>
           ...
           <hr>
           <br>
           <input type="submit" name="sub"  role="button" class="juju" value="View Attendance">
           <br>
           <br>
