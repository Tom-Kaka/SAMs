...
<body>
  ...
  <!--sidebar end-->
   ...
   <div class="btn_group">
        ...
        <br>
        <br>
       <form method="POST" action="contentadd_attendance.php" class="lolo">
          ...
          <option value="form4">Form 4</option>
           ...
           <br>
           <br>
           <input type="submit"  name="sub" value="Add Attendance"  class="juju">
           <br>
           <br>
        <a href="view_Attendence.php"  class="btn btn_big">Back</a>
       </form>
    </div>
