...
<body>
  ...
  <!--sidebar end-->
   <div class="content">
      ...
      <hr>
      <br>
      <p>You have succefully login to the Student attendence managment system(SAMs)</p>
      <br>
      <p><b>STUDENTS</b></p>
      <p>This functionality allows you as the Teacher to view your students once they have registered in SAMs.</p>
        <br>
      <p><b>ATTENDENCE</b></p>  
      <p>This functionallity allows you as the Teacher to view students attendence, with respect to the DAY,TIME and SUBJECT.</p>
      <br>
